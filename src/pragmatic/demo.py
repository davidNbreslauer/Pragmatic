...
def demo_scenarios() -> list[DemoScenario]:
    return [
        DemoScenario(
            ...
            notes="Default hackathon run: live SDK, live web source acquisition, Modal execution, and Workshop observability.",
        ),
        DemoScenario(
            id="core_loop",
            ...
            notes="Best first run when the audience needs to understand the loop.",
        ),
        DemoScenario(
            id="modal_fanout",
            name="Modal Fan-Out",
